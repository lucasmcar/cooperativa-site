...
<meta charset="UTF-8">
    ...
    <meta name="description" content="A Cooperativa Novos Horizontes fortalece empreendimentos da Economia Solidária, desenvolve projetos comunitários e impulsiona iniciativas de impacto social em Porto Alegre e região.">
    <meta name="keywords" content="economia solidária, cooperativa, Porto Alegre, projetos sociais, inclusão produtiva, empreendimentos sociais, eco vila popular">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center ms-3 gap-3 social-icons">
                    ...
                    <a href="https://instagram.com/coop.novoshorizontes" target="_blank"><i class="bi bi-instagram"></i></a>
                    <a href="https://www.facebook.com/cooperativanovoshorizontes" target="_blank"><i class="bi bi-facebook"></i></a>
                </div>
            </div>
        </div>
    </nav>
